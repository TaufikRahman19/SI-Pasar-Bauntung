...
<div class="form-group">
    ...
    <table border="0">
        <tr>
            ...
            <td width="200">: {{ $kegiatan->kode_kegiatan }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Judul</td>
            <td width="200">: {{ $kegiatan->judul_kegiatan }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tanggal</td>
            <td width="200">: {{ $kegiatan->tanggal }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tempat</td>
            <td width="200">: {{ $kegiatan->tempat }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Perihal</td>
            <td width="200">: {{ $kegiatan->perihal }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Keterangan</td>
            <td width="200">: {{ $kegiatan->keterangan }}</td>
        </tr>
    </table>
