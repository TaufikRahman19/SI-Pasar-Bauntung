            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    @if ($errors->any)
                        ...
                        @endif
                    <form action="{{route('tambahkan')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" readonly value="{{ Auth::user()->name}}" class="form-control form-control" id="nama" name="nama" required>
                                    </div>
                                    <div class="form-group">
