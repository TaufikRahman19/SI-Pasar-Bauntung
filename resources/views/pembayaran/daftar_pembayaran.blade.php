                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary btn-round ml-auto" href="{{ route('pembayaran.form.tambah') }}">
                                ...
                                <a class="btn btn-primary btn-round ml-auto" href="{{ route('pertama') }}">
                                    <i class="fa fa-plus"></i>
                                    Tambah
                                </a>
                                @endif
                                <a class="btn btn-danger btn-round ml-3" href="{{ route('cetak_pembayaran') }}"
                                    target="_blank">
