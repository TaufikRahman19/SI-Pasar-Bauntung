                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control" name="namaSales" id="namaSales" value="{{$payment->sales_name}}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Telephone</label>
                                        <input type="number" class="form-control form-control" name="phoneSales" id="phoneSales" value="{{$payment->sales_phone}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
