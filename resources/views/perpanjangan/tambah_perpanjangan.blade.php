@extends('layout.main')
@section('title', 'Tambah Perpanjangan Pedagang')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="{{ route('perpanjangan.tambah') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="pedagang_id" id="pedagang_id" readonly onchange="autofill()"
                                                ...
                                                @foreach ($pedagangs as $pedagang)
                                                    <option value="{{ $pedagang->id }}" {{ $pedagang->nama ==  Auth::user()->pedagang->nama  ? 'selected' : '' }} value="{{ $pedagang->id }}" >{{ $pedagang->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="card-footer text-right">
                                <a href="{{ route('perpanjangan.index') }}" class="btn btn-danger">Batal</a>&nbsp;
