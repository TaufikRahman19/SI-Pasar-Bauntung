@extends('layout.main')
@section('title', 'Daftar Pembayaran Pertama')
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('pertama.index') }}">Pembayaran Pajak Pertama</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary btn-round ml-auto" href="{{ route('pertama.form.tambah') }}">
                                    <i class="fa fa-plus"></i>
                                    Tambah
                                </a>
                                <a class="btn btn-danger btn-round ml-3" href="{{ route('cetak_pertama') }}"
                                    target="_blank">
                                    ...
                                    <tbody>
                                        @foreach ($pertamas as $pertama)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{asset('buktibyr/'.$pertama->bukti) }}" target="#blank" rel="noopener noreferrer">Lihat Gambar</a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('pertama.detail', $pertama->id) }}">Cetak Struk</a>
                                                        <div role="separator" class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="{{ route('pertama.edit', $pertama->id) }}">Edit</a>
                                                        <div role="separator" class="dropdown-divider"></div>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#hapusModal{{ $pertama->id }}">Hapus</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
...
@section('modal')
    <!-- Hapus Modal -->
    @foreach ($pertamas as $pertama)
        <div class="modal fade" id="hapusModal{{ $pertama->id }}" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('pertama.hapus', $pertama->id) }}" method="POST">
                        @method ('DELETE')
                        @csrf
                        <div class="modal-body">
                            <p>Yakin untuk menghapus data dengan nama {{ $pertama->pedagang->nama }} ?</p>
                        </div>
