...
<div class="form-group">
    ...
    <table border="0">
        <tr>
            ...
            <td width="200">: {{ $pertama->pedagang->no_register }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">NIK</td>
            <td width="200">: {{ $pertama->pedagang->nik }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Nama Pedagang</td>
            <td width="200">: {{ $pertama->pedagang->nama }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Nomor Toko</td>
            <td width="200">: {{ $pertama->pedagang->toko->no_toko }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Jenis Toko</td>
            <td width="200">: {{ $pertama->pedagang->toko->jenis_toko }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Ukuran</td>
            <td width="200">: {{ $pertama->pedagang->toko->ukuran }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Massa Kontrak</td>
            <td width="200">: {{ $pertama->perbulan }} Bulan</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Harga Pajak</td>
            <td width="200">: Rp.{{ currency($pertama->pajak_id) }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Total</td>
            <td width="200">: Rp.{{ currency($pertama->total) }}</td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Kembali</td>
            <td width="200">: Rp.{{ currency($pertama->kembali) }}</td>
        </tr>
    </table>
</div>
<br>
