@extends('layout.main')
@section('title', 'Tambah Pembayaran Pertama')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="{{ route('pertama.tambah') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach ($pedagangs as $pedagang)
                                                <option value="{{ $pedagang->massa_kontrak }}">{{ $pedagang->massa_kontrak }}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                        <div class="form-group">
