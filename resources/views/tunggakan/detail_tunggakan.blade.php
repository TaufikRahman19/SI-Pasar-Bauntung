...
<table border="0" align="center">
    ...
    <tr>
        ...
        <td width="250">Bpk / Ibu / Sdr(i) {{ $tunggakan->pedagang->nama }}</td>
    </tr>
    <tr>
        <td></td>
        <td width="435"></td>
        <td width="250">Nomor Toko : {{ $tunggakan->pedagang->toko->no_toko }} </td>
    </tr>
    <tr>
        <td></td>
        <td width="435"></td>
...
<p align="justify">Berdasarkan Peraturan Daerah Kota Banjarbaru Nomor 5 Tahun 2021 Tentang Perubahan Atas Peraturan
    ...
    Laporan Hasil BPK RI Nomor 4.B/LHP/XIX.BJM/05/2022 tanggal {{ $tunggakan->created_at->isoFormat('D MMMM Y') }}
...
<table border="0">
    <tr>
        <td align="center" width="750"><h2><strong>Rp.{{ currency($tunggakan->total) }}</strong></h2></td>
    </tr>
</table>
<table border="0">
    <tr>
