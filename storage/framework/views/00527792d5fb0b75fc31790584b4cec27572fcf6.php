<?php $__env->startSection('title', 'Edit Pembayaran Pertama'); ?>
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('pertama.index')); ?>">Pembayaran Pertama</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('pertama.update', $pertama->id)); ?>">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="pedagang_id" id="pedagang_id"
                                                ...
                                                <option value="<?php echo e($pertama->pedagang_id); ?>">
                                                    <?php echo e($pertama->pedagang->nama); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="perbulan" id="perbulan"
                                                ...
                                                <option value="<?php echo e($pertama->perbulan); ?>">
                                                    <?php echo e($pertama->pedagang->massa_kontrak); ?></option>
                                                <?php $__currentLoopData = $pedagangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedagang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="pajak_id" id="pajak_id"
                                                ...
                                                <option value="<?php echo e($pertama->pajak_id); ?>">
                                                    <?php echo e($pertama->pajak_id); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control" id="total" name="total"
                                                value="<?php echo e($pertama->total); ?>" onclick="hitungHarga()" readonly
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control" id="bayar" name="bayar"
                                                value="<?php echo e($pertama->bayar); ?>" onclick="hitungHarga()" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Kembalian</label>
                                            <input type="number" class="form-control form-control" id="kembali"
                                                name="kembali" value="<?php echo e($pertama->kembali); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="keterangan" id="keterangan ">
                                                ...
                                                <option value="Lunas"
                                                    <?php echo e($pertama->keterangan == 'Lunas' ? 'selected' : ''); ?>>Lunas</option>
                                                <option value="Belum Lunas"
                                                    <?php echo e($pertama->keterangan == 'Belum Lunas' ? 'selected' : ''); ?>>Belum
                                                    Lunas</option>
                                            </select>
                                        </div>
                            ...
                            <div class="card-footer text-right">
                                <a href="<?php echo e(route('pertama.index')); ?>" class="btn btn-danger">Batal</a>&nbsp;
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pertama/edit_pertama.blade.php ENDPATH**/ ?>