<?php $__env->startSection('title', 'Edit Perpanjangan Pedagang'); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('perpanjangan.update', $perpanjangan->id)); ?>">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="pedagang_id" id="pedagang_id"
                                                ...
                                                <option value="<?php echo e($perpanjangan->pedagang_id); ?>">
                                                    <?php echo e($perpanjangan->pedagang->nama); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control" id="bulan"
                                                name="bulan" value="<?php echo e($perpanjangan->bulan); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="pajak_id" id="pajak_id"
                                                ...
                                                <option value="<?php echo e($perpanjangan->pajak_id); ?>">
                                                    <?php echo e($perpanjangan->pajak_id); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control" id="total"
                                                name="total" value="<?php echo e($perpanjangan->total); ?>" onclick="hitungHarga()"
                                                readonly required>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/perpanjangan/edit_perpanjangan.blade.php ENDPATH**/ ?>