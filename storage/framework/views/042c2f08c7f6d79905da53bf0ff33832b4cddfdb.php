...
<table align="center">
    ...
    <tr>
        <td>Perihal</td>
        <td width="635">: Laporan Data Toko</td>
    </tr>
</table>
    ...
    <table border="1" align="center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <center><img src="<?php echo e(asset('fotoToko/'.$toko->foto)); ?>" width="20%" alt="" srcset=""></center>
                </td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/toko/cetak_toko.blade.php ENDPATH**/ ?>