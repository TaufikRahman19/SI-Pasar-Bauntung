<?php $__env->startSection('title', 'Daftar Antrian Pengiriman'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ml-auto" href="<?php echo e(route('pengiriman.form.tambah')); ?>">
                            ...
                            <table id="daftarPengiriman" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php echo rowColor($shipping->prioritas); ?>>
                                        ...
                                        <td>
                                            <?php echo e($shipping->detailItems()); ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item sendBtn" data-toggle="modal" data-target="#kirimPesanan" data-pengiriman="<?php echo e($shipping->id); ?>">Kirim Pesanan</a>
                                                ...
                                                <div role="separator" class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="<?php echo e(route('pengiriman.form.edit', $shipping->id)); ?>">Edit</a>
                                                <div role="separator" class="dropdown-divider"></div>
                                                <form class="formDelete" action="<?php echo e(route('pengiriman.hapus', $shipping->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/pengiriman/daftar_pengiriman.blade.php ENDPATH**/ ?>