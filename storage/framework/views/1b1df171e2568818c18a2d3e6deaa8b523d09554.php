                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('pedagang.detail', $pedagang->id)); ?>">Detail</a>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('pedagang.hapus', $pedagang->id)); ?>" method="POST">
                ...
                <div class="modal-body">
                    <p>Yakin untuk menghapus data dengan nama <?php echo e($pedagang->name); ?> ?</p>
                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/pedagang/daftar_pedagang.blade.php ENDPATH**/ ?>