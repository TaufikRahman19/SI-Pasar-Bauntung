                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ml-auto" href="<?php echo e(route('datadiri')); ?>">
                                <i class="fa fa-plus"></i>
                                Tambah
                            </a>
                            <?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('pedagang.kartu', $pedagang->id)); ?>">Cetak Kartu Pedagang</a>
                                                <div role="separator" class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="<?php echo e(route('pedagang_verif', $pedagang->id)); ?>">Verifikasi Pembayaran</a>
                                                <div role="separator" class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="<?php echo e(route('pedagang_tunggak', $pedagang->id)); ?>">Kirim Surat Tunggakan</a>
                                                <div role="separator" class="dropdown-divider"></div>
