        ...
        <tbody>
            <?php $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($item->pedagangs->nama); ?></td>
                    <td><?php echo e($item->pedagangs->toko->no_toko); ?></td>
                    <td><?php echo e($item->pedagangs->tgl_berjualan); ?></td>
                    <td><?php echo e($item->pedagangs->toko->jenis_toko); ?></td>
                    <td>Rp.<?php echo e(currency($item->pajak_id)); ?></td>
                    <td><center><?php echo e($item->perbulan); ?></center></td>
                    <td>Rp.<?php echo e(currency($item->total)); ?></td>
...
<?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pembayaran/cetak-pembayaran-detail.blade.php ENDPATH**/ ?>