        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('kegiatan.tambah')); ?>" method="POST" id="kegiatan" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo e($nomor); ?>" readonly class="form-control form-control" id="kode_kegiatan" name="kode_kegiatan" autofocus required>
                                    </div>
                                    <div class="form-group">
