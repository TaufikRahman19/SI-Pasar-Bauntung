...
<head>
    ...
    <title>Surat Tunggakan Pedagang</title>
</head>
<table align="center">
    <tr>
        <td>
...
<table border="0" align="center">
    ...
    <tr>
        ...
        <td width="250">Bpk / Ibu / Sdr(i) <?php echo e($tunggakan->pedagang->nama); ?></td>
    </tr>
    <tr>
        <td></td>
        <td width="435"></td>
        <td width="250">Nomor Toko : <?php echo e($tunggakan->pedagang->toko->no_toko); ?> </td>
    </tr>
    <tr>
        <td></td>
        <td width="435"></td>
...
<p align="justify">Berdasarkan Peraturan Daerah Kota Banjarbaru Nomor 5 Tahun 2021 Tentang Perubahan Atas Peraturan
    ...
    Laporan Hasil BPK RI Nomor 4.B/LHP/XIX.BJM/05/2022 tanggal <?php echo e($tunggakan->created_at->isoFormat('D MMMM Y')); ?>
...
<table border="0">
    <tr>
        ...
        <td>
            <p align="justify"> Menghindari tunggakan Pajak Toko Tahun 2022, maka kami harapkan Bapak/Ibu/saudara(i)
    ...
    <tr>
        ...
        <td>
            <p align="justify">Agar Segera melunasi tunggakan/hutang Pajak Toko di Pasar Bauntung Banjarbaru untuk
                menghindari penerapan sanksi sesuai Peraturan Daerah Nomor 10 Tahun 2021. Adapun tunggakan sebesar. </p>
        </td>
    </tr>
</table>
<table border="0">
    <tr>
        <td align="center" width="750"><h2><strong>Rp.<?php echo e(currency($tunggakan->total)); ?></strong></h2></td>
    </tr>
</table>
<table border="0">
    <tr>
    ...
    <tr>
        ...
        <td>
            <p align="justify">Untuk Pembayaran Pajak Toko atau Tunggakan dapat dilakukan di Kantor UPT Pasar Bauntung
...
<?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/tunggakan/detail_tunggakan.blade.php ENDPATH**/ ?>