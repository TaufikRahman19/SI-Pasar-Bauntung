...
<div class="form-group">
    <br>
    <h1>
        <center>Surat Pemberitahuan Kegiatan</center>
    </h1>
    <table border="0">
        <tr>
            <td width="150">Kode Kegiatan</td>
            <td width="200">: <?php echo e($kegiatan->kode_kegiatan); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Judul</td>
            <td width="200">: <?php echo e($kegiatan->judul_kegiatan); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tanggal</td>
            <td width="200">: <?php echo e($kegiatan->tanggal); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tempat</td>
            <td width="200">: <?php echo e($kegiatan->tempat); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Perihal</td>
            <td width="200">: <?php echo e($kegiatan->perihal); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Keterangan</td>
            <td width="200">: <?php echo e($kegiatan->keterangan); ?></td>
        </tr>
    </table>
...
<?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/kegiatan/detail_kegiatan.blade.php ENDPATH**/ ?>