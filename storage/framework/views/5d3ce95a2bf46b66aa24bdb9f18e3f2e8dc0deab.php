            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('pegawai.tambah')); ?>" method="POST" id="pegawai" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pegawai/tambah_pegawai.blade.php ENDPATH**/ ?>