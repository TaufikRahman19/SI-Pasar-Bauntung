                            ...
                            <div class="row">
                                <div class="col-sm-3 pr-0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control" id="namaPembeli" name="namaPembeli" value="<?php echo e($pengiriman->nama_pembeli); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 pr-0">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control form-control" id="alamatPembeli" name="alamatPembeli" value="<?php echo e($pengiriman->alamat_pembeli); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 pr-0">
                                    <div class="form-group">
                                        <label>Telephone</label>
                                        <input type="text" class="form-control form-control" id="phonePembeli" name="alamatPembeli" value="<?php echo e($pengiriman->phone); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3 pr-0">
                                    <div class="form-group">
                                        <label>Tanggal</label>
                                        <input type="date" class="form-control form-control" id="tglPengiriman" name="tglPengiriman" value="<?php echo e($pengiriman->tanggal_pengiriman); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-3 pr-0">
                                    <div class="form-group">
                                        ...
                                        <table id="daftarItem" class="display table table-striped table-hover">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><b><span id="grandTotal"><?php echo e($pengiriman->grandtotal); ?></span></b></td>
                                                    <td></td>
                                                </tr>
                                            </tfoot>
                                        </table>
...
<script>
    $(document).ready(function() {
        ...
        $('#submitShipping').click(function(event) {
            ...
            $.ajax({
                data: sale,
                url: "<?php echo route('pengiriman.edit',['pengiriman'=>$pengiriman->id]); ?>",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    swal.close();
                    swalSuccess('Edit data pengiriman berhasil');
                    window.location.href = "<?php echo route('pengiriman.index'); ?>";
                },
                error: function(data) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pengiriman/edit_pengiriman.blade.php ENDPATH**/ ?>