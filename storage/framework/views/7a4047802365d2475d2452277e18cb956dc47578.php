        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="purchaseForm" action="<?php echo e(route('penjualan.tambah')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-danger">Batal</a>&nbsp;
...
<script>
    $(document).ready(function() {
        ...
        $('#purchaseForm').submit(function(event) {
            ...
            $.ajax({
                data: purchase,
                url: "<?php echo route('penjualan.tambah'); ?>",
                type: "POST",
                dataType: 'json',
    ...
    function tambah_pembelian() {
        ...
        if (status == 'lunas') {
            ...
            if (jml_bayar <= 0) {
                ...
                // window.location.href = "<?php echo e(route('pembelian.tambah')); ?>";
                alert("Sukses !");
            }
        }
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/penjualan/tambah_penjualan.blade.php ENDPATH**/ ?>