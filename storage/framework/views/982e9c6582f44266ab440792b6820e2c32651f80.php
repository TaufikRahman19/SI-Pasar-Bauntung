                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-danger btn-round ml-3" href="<?php echo e(route('cetak_pegawai')); ?>" target="_blank">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(asset('sk_pegawai/'.$pegawai->sk_pegawai)); ?>" target="#blank" rel="noopener noreferrer">Lihat SK Pegawai</a>
                                            <?php else: ?>
                                            Tidak Ada Data
                                        <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('pegawai.edit', $pegawai->id)); ?>">Edit</a>
                                                <div role="separator" class="dropdown-divider"></div>
                                                <a class="dropdown-item" data-toggle="modal" data-target="#hapusModal<?php echo e($pegawai->id); ?>">Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
