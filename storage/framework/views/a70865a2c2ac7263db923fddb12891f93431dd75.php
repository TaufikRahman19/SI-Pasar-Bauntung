...
<table align="center">
    ...
    <tr>
        <td>Perihal</td>
        <td width="635">: Laporan Data Kegiatan</td>
    </tr>
</table>
    ...
    <table border="1" align="center">
        <thead>
            <tr>
                ...
                <th width="100">Judul Kegiatan</th>
                <th width="80">Tanngal</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <center><img src="<?php echo e(asset('fotoKegiatan/'.$kegiatan->foto)); ?>" width="20%" alt="" srcset=""></center>
                </td>
            </tr>
