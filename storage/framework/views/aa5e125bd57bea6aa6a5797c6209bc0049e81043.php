...
<div class="form-group">
    ...
    <table border="0">
        <tr>
            ...
            <td width="200">: <?php echo e($event->kegiatan->kode_kegiatan); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Judul</td>
            <td width="200">: <?php echo e($event->kegiatan->judul_kegiatan); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tanggal Mulai</td>
            <td width="200">: <?php echo e($event->kegiatan->tanggal_mulai); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tanggal Selesai</td>
            <td width="200">: <?php echo e($event->kegiatan->tanggal_selesai); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Tempat</td>
            <td width="200">: <?php echo e($event->kegiatan->tempat); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Perihal</td>
            <td width="200">: <?php echo e($event->kegiatan->perihal); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Keterangan</td>
            <td width="200">: <?php echo e($event->kegiatan->keterangan); ?></td>
        </tr>
    </table>
    <table border="0">
        <tr>
            <td width="150">Status</td>
            <td width="200">: <?php echo e($event->status); ?></td>
        </tr>
    </table>
...
<?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/event/detail_event.blade.php ENDPATH**/ ?>