<?php $__env->startSection('title', 'Daftar pembayaran Lunas'); ?>
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Daftar Pembayaran Lunas</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Daftar Pembayaran Lunas</h4>

                                <a class="btn btn-danger btn-round ml-auto" href="<?php echo e(route('cetak_lunas')); ?>"
                                    target="_blank">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pembayaran/lunas_pembayaran.blade.php ENDPATH**/ ?>