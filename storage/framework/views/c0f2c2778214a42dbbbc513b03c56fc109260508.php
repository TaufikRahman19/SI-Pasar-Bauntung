                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control" id="deskripsiTokoEdit" name="deskripsiTokoEdit"  value="<?php echo e($toko->deskripsi); ?>" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <img src="<?php echo e(asset('fotoToko/'.$toko->foto)); ?>" width="45%" alt="" srcset="">
                                    </div>
                                </div>
                            </div>
                        </div>
