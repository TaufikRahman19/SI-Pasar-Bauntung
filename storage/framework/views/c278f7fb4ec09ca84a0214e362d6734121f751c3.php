<?php $__env->startSection('title', 'Tunggakan pedagang'); ?>
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#">Kirim Surat Tunggakan</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Kirim Surat Tunggakan</h4>
                            </div>
                        </div>
                        <?php if($errors->any): ?>
                            <ul class="list-group">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('tunggakan_pedagang', $pedagang->id)); ?>" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control" name="tunggakan_id"
                                                ...
                                                <?php $__currentLoopData = $tunggakans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tunggakan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tunggakan->id); ?>"><?php echo e($tunggakan->pedagang->nama); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pedagang/tunggakan_pedagang.blade.php ENDPATH**/ ?>