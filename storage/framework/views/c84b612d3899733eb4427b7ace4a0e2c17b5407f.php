                ...
                <div class="card">
                    ...
                    <form id="purchaseForm" method="POST">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('pembelian.index')); ?>" class="btn btn-danger">Batal</a>&nbsp;
    ...
    $(document).ready(function() {
        ...
        $('#simpanSupplier').click(function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('pembelian.supplier.tambah'); ?>",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    swal.close();
                    swalSuccess('Tambah data supplier berhasil');
                    window.location.href = "<?php echo route('pembelian.form.tambah'); ?>";
                },
                error: function(data) {
        ...
        $('#submitPurchase').click(function(event) {
            ...
            $.post("<?php echo route('pembelian.tambah'); ?>",purchase,function(data){
                swal.close();
                swalSuccess('Tambah data pembelian berhasil');
                window.location.href = "<?php echo route('pembelian.index'); ?>";
            }).fail(function(xhr) {
                var message = "";
                if(xhr.status == 422){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/pembelian/tambah_pembelian.blade.php ENDPATH**/ ?>