                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control" name="massa_kontrakPedagangEdit" id="massa_kontrakPedagangEdit ">
                                            ...
                                            <option value="6 Bulan"<?php echo e($pedagang->massa_kontrak == "6 Bulan" ? 'selected' : ''); ?>>6 Bulan</option>
                                            <option value="12 Bulan"<?php echo e($pedagang->massa_kontrak == "12 Bulan" ? 'selected' : ''); ?>>12 Bulan</option>
                                            <option value="24 Bulan"<?php echo e($pedagang->massa_kontrak == "24 Bulan" ? 'selected' : ''); ?>>24 Bulan</option>
                                            <option value="36 Bulan"<?php echo e($pedagang->massa_kontrak == "36 Bulan" ? 'selected' : ''); ?>>36 Bulan</option>
                                            </select>
                                    </div>
                                    <div class="form-group">
