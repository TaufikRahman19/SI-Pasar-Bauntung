    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('pembelian.index')); ?>">Pengiriman</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="shippingForm" action="<?php echo e(route('pengiriman.tambah')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('pengiriman.index')); ?>" class="btn btn-danger">Batal</a>&nbsp;
...
<script>
    $(document).ready(function() {
        ...
        $('#shippingForm').submit(function(event) {
            ...
            $.ajax({
                data: shipping,
                url: "<?php echo route('pengiriman.tambah'); ?>",
                type: "POST",
                dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/pengiriman/tambah_pengiriman2.blade.php ENDPATH**/ ?>