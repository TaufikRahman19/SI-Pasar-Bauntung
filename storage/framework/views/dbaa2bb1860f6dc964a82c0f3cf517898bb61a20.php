        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="<?php echo e(route('supplier.tambah')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('supplier.index')); ?>" class="btn btn-danger">Batal</a>&nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Toko-Bagunan-master\resources\views/supplier/tambah_supplier.blade.php ENDPATH**/ ?>