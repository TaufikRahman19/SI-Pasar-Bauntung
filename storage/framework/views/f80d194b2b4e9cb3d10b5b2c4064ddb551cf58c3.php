<?php $__env->startSection('title', 'Daftar pembayaran Online'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-danger btn-round ml-auto" href="<?php echo e(route('cetak_online')); ?>"
                                    target="_blank">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI-Pasar-Bauntung\resources\views/pembayaran/online_pembayaran.blade.php ENDPATH**/ ?>